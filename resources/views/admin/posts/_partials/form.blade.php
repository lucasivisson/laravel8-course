@if (isset($errors)) <!-- o método any() retorna true, caso existe erros-->
    <ul>
...
<button type="submit" class="w-full py-3 mt-6 font-medium tracking-widest uppercase bg-black shadow-lg focus:outline-none hover:bg-gray-900 hover:shadow-none">Cadastrar produto</button>
